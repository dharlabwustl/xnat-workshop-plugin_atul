...
package org.nrg.xnat.sniDataatul.plugin;
...
@XnatPlugin(value = "sniDataatulPlugin", name = "XNAT 1.7 Workshop 2016 Plugin", entityPackages = "org.nrg.xnat.workshop.entities",
...
//                                         plural = "Biosample Collections")})
            dataModels = {@XnatDataModel(value = "sni:sniDataatul",
        singular = "Biosample Collection",
        plural = "Biosample Collections")})
...
public class SniDataatulPlugin {
//    @Bean
